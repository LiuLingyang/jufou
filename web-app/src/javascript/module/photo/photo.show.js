var f = function(){
    ...
    _proModulePhotoShow.__doBuild = function(){
        ...
        this.__cache = _t._$$CacheAlbum._$allocate({
            ...
            onlistload:this.__cbListLoad._$bind(this)
        });
    };
    /**
     * 
     ...
     * 
     */
    _proModulePhotoShow.__cbListLoad = function(_options){
    	...
    	switch(_key){
    		...
    		case 'photo':
    			_e._$renderHtmlTemplate(
    				this.__nallp,'jst-photo-all-list',{
    					cid:this.__photo.id,
    					xlist:this.__cache._$getListInCache(_options.key)
    				}
    			);
    		break;
    	}
