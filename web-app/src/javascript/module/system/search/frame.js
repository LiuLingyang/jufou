var f = function(){
    ...
    _proModuleSearchFrame.__doBuild = function(){
        ...
        this.__locked = !1;
        _v._$addEvent(
            _t._$$CacheMeeting,'countupdate',
            this.__cbCountUpdate._$bind(this)
        );
        _v._$addEvent(
            _t._$$CacheGroup,'countupdate',
            this.__cbCountUpdate._$bind(this)
        );
    };
    /**
     ...
     * @param {Object} _map
     */
    _proModuleSearchFrame.__cbCountUpdate = function(_map){
    	var _sum = 0,
    	    _list = this.__ctab._$getList();
        _map = _map||_o;
        _u._$forEach(
            _list,function(_node){
            	var _element = _e._$getByClassName(_node,'j-fwg')[0],
            	    _count = _map[_e._$dataset(_node,'value')]||0;
                _sum += _count;
                if (!!_element){
        ...
        // all
        var _element = _e._$getByClassName(_list[0],'j-fwg')[0];
        if (!!_element){
        	_element.innerText = _sum;
        }
    };
};
