var f = function(){
    ...
    // html code
    if(_e._$get("meeting-state"))
    var state = _e._$get("meeting-state").value;
    var htmlStr = "";
    htmlStr += '<a class="mix" href="#" data-action="0">回复状态编辑</a>';
    htmlStr += '<a class="mix" href="#" data-action="1">查看用户问题回复</a>';
    if(state == 2){
    	htmlStr += '<a class="mix" href="#" data-action="5">恢复活动回复</a>';
    }else{
    	htmlStr += '<a class="mix" href="#" data-action="2">停止回复</a>';
    }
    htmlStr += '<a class="mix" href="#" data-action="3">打印参加者名单</a>';
    htmlStr += '<a class="mix" href="#" data-action="4">群通知参加者</a>';
    var _seed_html = _e._$addNodeTemplate(htmlStr);
    /**
     * 窗体控件基类
     * 
     */
