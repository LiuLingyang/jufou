var f = function(){
    ...
    var _seed_html = _e._$addNodeTemplate('\
        <form class="w-fom">\
          <table class="xtb">\
            ...
            <tr class="cxx"><td class="c0">公司</td>\
                <td class="c1 cyy"><input type="text" class="txt bd01 w-rd3 wd0" name="company" maxlength="30"/></td></tr>\
            ...
            <tr class="cxx"><td class="c0">手机号码</td>\
                ...
                <tr class="cxx"><td class="c0">QQ</td>\
                <td class="c1 cyy"><input type="text" class="txt bd01 w-rd3 wd0" name="qq" maxlength="15"/></td></tr>\
          </table>\
          <div class="xbtn f-cb">\
    ...
    _proWindowContactCreate.__reset = function(_options){
        _options.title = _options.title||'创建组织联系人';
...
define('{pro}widget/window/group.contact.create.js',
