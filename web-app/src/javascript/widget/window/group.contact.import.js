          ...
          <table class="xtb">\
            <tr><td class="c0"><input type="radio" checked="checked" id="type"/></td>\
                <td class="c1">\
                  ...
                  <p class="ln ln1 fc00">请将联系人存储为下边的格式</p>\
                  <p class="ln fc00">第一行为姓名、邮箱、手机号码等的文字描述</p>\
                  <img src="/res/test/groupcontact.png" class="gcimg"/>\
                  <div class="act">\
...
define('{pro}widget/window/group.contact.import.js',
