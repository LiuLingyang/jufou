...
var f = function(){
    var _  = NEJ.P,
        ...
        _proCustomEditor2,
        _supCustomEditor2;
    if (!!_p._$$CustomEditor2) return;
    // ui html code
    var _seed_html;
    /**
     * 富媒体编辑器封装
     * @class   {nej.ui._$$CustomEditor2} 富媒体编辑器封装
     * @extends {nej.ui._$$Editor}
     * @param   {Object} 可选配置参数，已处理参数列表如下
     */
    _p._$$CustomEditor2 = NEJ.C();
      _proCustomEditor2 = _p._$$CustomEditor2._$extend(_i._$$Editor);
      _supCustomEditor2 = _p._$$CustomEditor2._$supro;
    /**
     * 初始化外观信息
     * @protected
     * @method {__initXGui}
     * @return {Void}
     */
    _proCustomEditor2.__initXGui = function(){
        _supCustomEditor2.__initXGui.apply(this,arguments);
     ...
     * @return {Void}
     */
    _proCustomEditor2.__initNodeTemplate = (function(){
        ...
        return function(){
            _seed_html = _e._$addNodeTemplate(
                this.__doGenEditorXhtml({
                    toolbar:this.__doGenCmdXhtml({xlist:_vlist,hr:!0})
                    	   +this.__doGenFontSizeXhtml()
...
define('{pro}widget/editor/editor2.js',
