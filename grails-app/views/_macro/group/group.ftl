...
<#macro groupMeetingStateTemplate>
  ...
  <textarea name="jst" id="jst-meeting-state">
    ...
    {elseif (meeting.endTime!=0&&meeting.endTime<now)||(meeting.endTime==0&&(meeting.startTime+24*60*60*1000)<now)}
      <input class="w-rd3 t-btn t-btn-6 js-btn-disabled" type="button" value="活动已结束"/>
    ...
    {elseif meeting.signupEndTime!=0&&meeting.signupEndTime<now}
    ...
    {elseif state==1}
      <a class="w-rd3 t-btn t-btn-1 tip" href="/${homepage}/meeting/${meeting.id}/">不参加</a>
    {elseif state==2}
      <a class="w-rd3 t-btn t-btn-0 tip" href="/${homepage}/meeting/${meeting.id}/">已参加</a>
    {elseif state==3}
      <a class="w-rd3 t-btn t-btn-2" href="/${homepage}/meeting/${meeting.id}/">被参加</a>
    {elseif state==4}
      <a class="w-rd3 t-btn t-btn-2" href="/${homepage}/meeting/${meeting.id}/">被不参加</a>
    {elseif state==-2}
      <a class="w-rd3 t-btn t-btn-2" href="/${homepage}/meeting/${meeting.id}/">审核中..</a>
    {elseif state==-3}
      <a class="w-rd3 t-btn t-btn-2" href="/${homepage}/meeting/${meeting.id}/">被拒绝</a>
    {else}
    ...
    <div class="t-wrp t-nav">
      <div class="t-bdy f-cb">
        <div class="mlnk fl w-nlst f-cb">
          <#if options.relationship==0&&(group.viewPermission!0)==1>
            <a class="itm nit fl fx0<#if options.index==1> js-selected</#if>" href="/${homepage}/"  hidefocus="true">首页</a>
            <a class="itm fl cur fc06"  hidefocus="true">会员</a>
            <a class="itm fl cur fc06"  hidefocus="true">相册</a>
          <#else>
            <a class="itm nit fl fx0<#if options.index==1> js-selected</#if>" href="/${homepage}/" hidefocus="true">首页</a>
            <a class="itm nit fl fx0<#if options.index==2> js-selected</#if>" href="/${homepage}/members/" hidefocus="true">会员</a>
            <a class="itm nit fl fx0<#if options.index==3> js-selected</#if>" href="/${homepage}/album/" hidefocus="true">相册</a>
            <a class="itm nit fl fx0<#if options.index==6> js-selected</#if>" href="/${homepage}/vote/" hidefocus="true">投票</a>
            ...
            <#if options.relationship==3>
              ...
              <a class="itm nit fl fx0<#if options.index==5> js-selected</#if>" href="/${homepage}/apply/" hidefocus="true">开通</a>
              </#if>
            </#if>
            <div class="itm fl nit fx0">
              <span>更多</span>
              <div class="w-menu w-menu-1 bg00">
                <a class="mit fc00 bg07" href="/${homepage}/news/">新闻</a>
                <a class="mit fc00 bg07" href="/${homepage}/share/">互动</a>
                <a class="mit fc00 bg07" href="/${homepage}/contact/">通讯录</a>
                <#if group.id==69||group.id==157>
                <a class="mit fc00 bg07" href="/${homepage}/sub/">校分会</a>
                </#if>
              </div>
            </div>
          </#if>
        ...
        <div class="alnk fr w-nlst w-nlst-0 f-cb" id="group-menu-card">
          ...
          <div class="itm fr">
            ...
            <div class="w-menu bg00">
              ...
              <#if options.relationship==3>
              <a class="mit fc00 bg07" href="#" data-gid="${group.id}" id="group-menu-dismiss">解散组织</a>
              <#else>
          ...
          <div class="point_out" id="point_out_box" style="display:none;">
            <img src="/res/img/point_out.png">
            <div class="cancel" id="close_point_out"></div>
          </div>
          </#if>
        </div>
        </#if>
...
<#macro groupLeftSide group={} options={}>
  <div class="fl l-lsd">
    <@module id="1" class="s-srd">
      <div class="logo">
        <img class="js-flag" src="${group.thumbnail!p_logo2}"/>
        <#if options.relationship==3||options.relationship==2>
        <form class="act">
          <label class="b fc00 js-flag">上传组织logo</label>
      ...
      <div class="t-cnt">
        <div class="blk-0">
          ...
          <#if options.relationship==0>
          <p><a class="w-rd3 t-btn t-btn-0 tip" href="/${group.homepage}/join/">加入我们</a></p>
          </#if>
        </div>
        <#if options.relationship!=0>
          <p><a class="w-rd3 t-btn t-btn-0 tip" href="/${group.homepage}/about/">关于我们</a></p>
        </#if>
        <p><a class="w-rd3 t-btn t-btn-0 tip" href="javascript:;" data-gid="${group.id}" id="grcode_create">生成组织二维码</a></p>
        <div class="blk-2 bd00">
          <table class="w-stat">
            ...
            <tr><td class="c0">即将开始的活动</td>
                <td class="c1"><a class="fc02 js-href" data-url="${group.homepage}">${(options.upcomingCount)!0}</a></td></tr>
            <tr><td class="c0">已经结束的活动</td>
                <td class="c1"><a class="fc02 js-href" data-url="${group.homepage}">${(options.pastCount)!0}</a></td></tr>
          </table>
        </div>
      </div>
    </@module>
    <@module id="2" title="组织者" class="s-srd">
      ...
      <div class="w-lfac f-cb bd00">
        <div class="fl img"><img src="${(owner.portrait)!p_portrait}" class="w-rd5p"></div>
        <div class="dtl">
    ...
    <@module id="3" title="组织标签" class="s-srd">
      <#if group.tags??&&group.tags?size&gt;0>
        ...
        <a class="w-tag w-rd3 fl js-tag" href="#" data-text="${xx.name}">${xx.name}</a>
        </#list>
      <#else>
    ...
    <@module id="4" title="这个组织的会员还在" class="s-srd">
      ...
      <div class="w-lfac f-cb bd00">
        ...
        <div class="dtl">
          <p class="unm"><a class="fc02" href="/${xx.homepage}/">${xx.name}</a></p>
