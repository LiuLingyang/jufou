...
<#macro userPageSettingProfile user={}>
  <@module id="s1" title="个人资料" class="t-mda s-srd">
    <@userPageSettingProfileBlock title="头像" class="w-sblk-0">
      <div class="fl img">
        <img class="js-flag w-rd5p" src="${user.portrait!p_portraits}"/>
      ...
      <div class="fl">
        ...
        <div class="ln">
          <input type="button" value="上传文件" class="w-rd3 t-btn t-btn-1 js-flag"/>
          <span class="js-flag fc03" style="display:none;">点击按钮上传头像</span>
        </div>
      </div>
    ...
    <@userPageSettingProfileBlock title="关注我">
      <table class="w-stb">
        <tr><td class="c3 f-bg" colspan="2">新浪微博</td>
            <td class="c2 js-flxg"></td></tr>
        <tr><td class="c32 f-bg" colspan="2">人人</td>
            <td class="c2 js-flxg"></td></tr>
...
<#macro userPageSettingTemplate user={} host={}>
  ...
  <textarea name="ntp" id="ntp-message-item">
    <div class="w-mitm bd00">
      <div class="w-lfac f-cb">
        ...
        <div class="dtl">
          <p><a class="fc11 ftl js-flag" href="#"></a></p>
  ...
  <textarea name="jst" id="jst-profile-bind-action">
    {if !!sns}
    <a href="#" class="fc03" data-type="${type}" data-action="cancel">解除绑定</a>
    {else}
    <input type="button" value="绑定" class="w-rd3 t-btn t-btn-b" data-type="${type}" data-action="bind"/>
    {/if}
  </textarea>
  </#noparse>
</#macro>
