...
<#macro userPageHomeProfile user={}>
  <@module id="h0" class="s-srd">
    <div class="w-lfac w-lfac-h f-cb">
      <div class="fl img"><img src="${user.portrait!p_portrait}"/ class="w-rd5p"></div>
      <div class="dtl">
        <p class="hnm">欢迎回来！  ${user.nickname!user.username}</p>
...
<#macro userPageHomeMetting>
  <@module id="h1" class="t-mdc">
    ...
    <@taber items=["即将开始","已经结束"] index=-1 id="user-meeting"/>
