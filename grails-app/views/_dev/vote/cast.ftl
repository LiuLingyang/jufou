...
<html>
  <head>
    ...
    <link href="${css_root}group/vote.cast.css" rel="stylesheet" type="text/css"/>
  ...
  <body id="www-jufou-com">
    ...
    <@groupBody group=group
      ...
      <div class="l-lmc f-cb group-vote">
        <@messagebox/>
        <@groupVoteShow group=group vote=survey relation=relationship cast=true/>
      </div>
    </@groupBody>
    <@groupTemplateCollection group=group host=host>
      <@groupVoteCastTemplate vote=survey group=group/>
