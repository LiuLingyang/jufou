  ...
  <@module id="y1" class="s-srd">
    <form class="w-fom">
      ...
      <div class="cat w-tit f-nl">
        ...
        <a class="itm fc07 js-flag" hidefocus="true" href="#">所有</a>
        <#list d_group_category as x>
        <a class="itm fc07 js-flag" hidefocus="true" href="#" data-value="${x}">${x}</a>
        </#list>
      </div>
    </form>
  </@module>
...
<#macro sysSearchPageTemplate>
  ...
  <textarea name="jst" id="jst-group-list">
    ...
    <div class="fl w-grp bg00 bd07">
      <div class="img">
        <a class="fc02" href="/${x.homepage}/"><img src="${x.thumbnail|default:config.url.logo}"/></a>
      </div>
      <p class="ln f-tf" title="${x.name}"><a class="fc03" href="/${x.homepage}/">${x.name}</a></p>
      <p class="ln fc09">${x.memberCount|default:0}名会员</p>
  ...
  <textarea name="jst" id="jst-meeting-list">
    ...
    <div class="w-lfac w-lfac-a f-cb bd00">
      <div class="fl img"><a href="/${g.homepage}/"><img src="${g.thumbnail|default:config.url.logo}"/></a></div>
