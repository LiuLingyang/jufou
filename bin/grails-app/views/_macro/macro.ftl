...
<#assign css_root="/src/css/"
         ...
         ftl_root=(env=="product"||env=="test")?string("/_prd/","/_dev/")>
<#-- config data -->
<#include ftl_root+"config.ftl">
<#assign d_role_name=["","会员","管理员","创建者"]
  ...
  <div class="g-wrp g-hxd">
    <div class="g-bdy f-cb">
      ...
      <ul class="link fr f-cb">
        ...
        <li class="itm fr"><a href="/message/">消息</a></li>
        <li class="itm fr"><a href="/group/">我的组织</a></li>
        <li class="itm fr">
          <img class="prt w-rd5p" id="www-jufou-com-portrait" src="${(user.thumbnail)!p_portrait}"/>
