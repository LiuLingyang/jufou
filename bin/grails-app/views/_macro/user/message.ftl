...
<#macro userPageMessageType>
  <@module id="m0" class="s-srd">
    <div class="w-tit f-nl">
      <#local msType=[{"t":"最新活动","h":"meeting","i":1},
                      {"t":"我的评论","h":"comment","i":2},
                      {"t":"系统消息","h":"system","i":4},
                      {"t":"我的通知","h":"inform","i":3},
                      {"t":"我的私信","h":"private","i":5}]>
      <#list msType as x>
      <a class="itm js-flag" href="#/${x.h}/" data-value="/m/${x.i}/">${x.t}</a>
      </#list>
    </div>
  </@module>
</#macro>
...
<#macro userPageMessageTemplate>
  ...
  <textarea name="txt" id="txt-mdl-private">
    <@module id="m4" title="我的私信" class="t-mda w-mlst s-srd">
      <div class="lbox js-flag"></div>
      <div class="pbox js-flag"></div>
    </@module>
  </textarea>
  ...
  <textarea name="jst" id="jst-list-inform">
    {list beg..end as y}
      ...
      <div class="w-lfac f-cb bd00">
        ...
        <div class="dtl">
          <p><a class="fc02" href="/${g.ghomepage}/">${g.gname}：</a>${m.title}<p>${m.body|escape}</p></p>
          <p class="fc05">${m.createTime|format:'yyyy年MM月dd日 HH:mm'}</p>
        </div>
      </div>
    {/list}
  ...
  <textarea name="jst" id="jst-list-private">
    {list beg..end as y}
      ...
      <div class="w-lfac f-cb bd00">
        ...
        <div class="dtl">
          <p><a class="fc02" href="/${m.sender.id}/">${m.sender.nickname}：</a>${m.body}</p>
          <p class="fc05">${m.createTime|format:"yyyy年MM月dd日 HH:mm"}</p>
        </div>
      </div>
    {/list}
