...
<#macro groupFormSettingBasic group={} check=false>
    <div class="w-byk">
      ...
      <div class="ipt">
        <select class="bd01 w-rd3 wd4" name="category">
    ...
    <div class="w-byk">
      <p class="lab itm2">组织主页地址<span class="tip2 fc06">（可以自定义组织地址）</span><span class="emb fc03">*</span></p>
      <div class="ipt">
    ...
    <div class="w-byk">
      <div class="ipt acp">
        <label><input name="offline" value="1" type="checkbox" class="cbx" data-required="true" data-message="创建的组织必须为线下组织"/><span class="wrd">我所创立的是真的线下组织</span></label>
      </div>
    </div>
    </#if>
</#macro>
